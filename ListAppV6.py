...
7. Find out how many of one number is on your list
8. Clear your list and start again
9. Print your list
10. Organize your list
11. Add your list together
12. Quit the progam.    """)
        if choice == "1":
            addToList()
        elif choice == "2":
            ...
            recursiveBinarySearch(uniqueList, low, high, x)
        elif choice == "7":
            howMany()
        elif choice == "8":
            myList.clear()
...
def recursiveBinarySearch(uniqueList, low, high, x):
    if high >=low:
        ...
        if uniqueList[mid] == 'x':
            ...
            recursiveBinarySearch(uniqueList, low, mid-1, x)
        elif uniqueList[mid]>x:
            recursiveBinarySearch(uniqueList, mid+1, high, x)       
    else:
